...
bool UnweightedGraph::readGraphFromFile(string filepath) {
    clear();
...
SearchResult UnweightedGraph::BFS(int startVertex, bool outputToFile) {
...
SearchResult UnweightedGraph::DFS(int startVertex, bool outputToFile) {
    // Mark all vertices as not visited
    vector<bool> visited(numVertices, false);
...
void UnweightedGraph::writeTreeToFile(int startVertex, const vector<int>& parent, const vector<int>& level, string searchName) {
...
vector<vector<int>> UnweightedGraph::findConnectedComponents() {
...
int UnweightedGraph::shortestDistance(int source, int destination) {
...
int UnweightedGraph::estimateDiameter() {
    int maxDiameter = 0;
...
vector<int> UnweightedGraph::getSortedVertexDegrees(){
...
void UnweightedGraph::generateGraphInfoFile() {
...
int UnweightedGraph::getNumVertices() {
    return numVertices;
};
